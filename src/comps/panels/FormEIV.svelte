...
<form on:submit|preventDefault={handleSubmit}>
  ...
  <Select categoria={eiv.categorias} bind:selected={$eivs.categoria[0]} placeholder="Tipo de estudo de impacto"/>
  ...
  <Select categoria={eiv.status} bind:selected={$eivs.status[0]} placeholder="Situação do processo"/>
  ...
  <Select categoria={eiv.compensação} bind:selected={$eivs.tipo_compens[0]} placeholder="Tipo de mitigação e/ou compensação" req='false' />
  ...
  <Select categoria={eiv.situação} bind:selected={$eivs.execuc_compens[0]} placeholder="Situação da execução do termo de compromisso" req='false' />
  ...
  <Select categoria={gerais.distritos} bind:selected={$eivs.distrito[0]} placeholder="Nome do distrito"/>
